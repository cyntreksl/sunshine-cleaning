...
export default function ThankYouPage() { return <main id="main-content" className="message-page page-shell"><div><p className="eyebrow">Enquiry received</p><h1>Thank you. Your message is on its way.</h1><p>We will use the contact details you supplied to respond to your cleaning enquiry. If the timing is urgent, you can also call <a href="tel:+447426292238">+44 7426 292238</a>.</p><Link className="button" href="/">Return home</Link></div></main>; }
